...
// llvm::GlobalVariable* create_globalvar(llvm::LLVMContext &context, llvm::Module* module, llvm::IRBuilder<> &builder, std::string name){
//     llvm::GlobalVariable *gVar = new llvm::GlobalVariable(
//         builder.getInt32Ty(),        // 变量类型
//         false,                      // 是否是常量
//         GlobalValue::CommonLinkage,  // 连接性
//         nullptr,                    // 初始值
//         name                 // 变量名称
//     );
//     return gVar;
